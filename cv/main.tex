...
\noindent iOS Development: Swift (10+ years), Objective-C, SwiftUI, UIKit, Swift Concurrency (async/await, actors),
structured concurrency, GCD, RxSwift, Combine, XCTest, Apple's Human Interface Guidelines.\newline
\noindent Full-stack development: React, Next.js, TypeScript, backend integration (RESTful APIs, GraphQL),
database design (PostgreSQL, Supabase).\newline
\noindent Testing \& Quality: Unit testing (XCTest), integration testing, BDD (Quick, Nimble), end-to-end testing,
Make, Fastlane, CI/CD automation, GitHub Actions, TestFlight.\newline
\noindent Paradigms: Object-oriented design (OOP), Protocol-oriented design (POP), Functional programming patterns,
MVC, Clean Architecture, VIPER, MVVM, Redux, TCA.\newline
